...
class Simulation(SimulationState):
    ...
    def to_dict(self) -> SimPickle:
        ...
        sim_settings: SimSettings = {
            "gravity_entry": (g.gravity,),
            "air_res_entry": (g.air_res,),
            "friction_entry": (g.friction,),
            "temp_sc": (g.temp,),
            "speed_sc": (g.speed,),
            "show_fps": (g.show_fps,),
            "show_num": (g.show_num,),
            ...
            "top_bool": (g.top,),
            "bottom_bool": (g.bottom,),
            "left_bool": (g.left,),
            "right_bool": (g.right,),
            "grid_bool": (g.use_grid,),
            "grid_res_x_value": (g.grid_res_x,),
            "grid_res_y_value": (g.grid_res_y,),
            "delay_entry": (g.delay,),
            "calculate_radii_diff_bool": (g.calculate_radii_diff,),
