...
class SaveManager:
    ...
    def save(self):
        ...
        if filename != "":
            try:
                sim_settings = {
                    "gravity_entry": [self.sim.gui.gravity_entry.get(), "entry"],
                    ...
                    "calculate_radii_diff_bool": [
                        self.sim.gui.calculate_radii_diff_bool.get(),
                        "set",
                    ],
                ...
                particle_settings = {
                    "radius_entry": [self.sim.gui.radius_entry.get(), "entry"],
                    ...
                    "attr_strength_entry": [
                        self.sim.gui.attr_strength_entry.get(),
                        "entry",
                    ],
                    "gravity_mode_bool": [self.sim.gui.gravity_mode_bool.get(), "set"],
                    "repel_strength_entry": [
                        self.sim.gui.repel_strength_entry.get(),
                        "entry",
                    ],
                    "link_attr_break_entry": [
                        self.sim.gui.link_attr_break_entry.get(),
                        "entry",
                    ],
                    "link_repel_break_entry": [
                        self.sim.gui.link_repel_break_entry.get(),
                        "entry",
                    ],
                    "groups_entry": [self.sim.gui.groups_entry.get(), "entry"],
                    "separate_group_bool": [
                        self.sim.gui.separate_group_bool.get(),
                        "set",
                    ],
                }
